...
const  Aishopping= () => {
  return (
    ...
    <img src="https://assets-global.website-files.com/6571cd8955f9e7f772615980/6571cd8955f9e7f772615a65_GT_features_BG.webp"alt="AI Icon"/>
  </div>
    ...
    <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-8">Ai Shopping<br/>Assistance </h1>
